...
namespace FCG.Users.Infrastructure.Configuration
{
    public class UserConfiguration : IEntityTypeConfiguration<User>
    {
        public void Configure(EntityTypeBuilder<User> builder)         
        {
            ...
            builder.Property(p => p.Name).HasColumnType("VARCHAR(1000)").HasColumnName("DSC_EMAIL").IsRequired();
            builder.Property(p => p.Name).HasColumnType("VARCHAR(1000)").HasColumnName("DSC_SENHA").IsRequired();
